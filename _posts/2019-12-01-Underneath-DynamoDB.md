...
Amazon의 CTO Werner Vogels의 블로그 [All Things Distributed](https://www.allthingsdistributed.com/2012/01/amazon-dynamodb.html) 에는 DynamoDB가 어떻게 만들어졌는지에 대한 [포스트](https://www.allthingsdistributed.com/2012/01/amazon-dynamodb.html)가 올라와있다. 이에 따르면  DynamoDB는 Amazon이 원래 사용하던 SimpleDB라는 데이터베이스에 Dynamo의 디자인 일부를 접목시켜 만든 것이라고 한다. 이 글에서 가장 인상 깊었던 구절은 아래였다.
